...
<html lang="en">
<head>
<title>Anoca|Ajouter une annonce</title>
...
<body>
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.html"><i class="fa fa-home home_1"></i></a> / <span>Ajouter une annonce</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	<!-- Submit Ad -->
	<div class="submit-ad main-grid-border">
		<div class="container">
			...
			<div class="post-ad-form">
				<form method="post" action="postemp">
					...
					<input type="text" class="phone" name="titre" placeholder="">
					<div class="clearfix"></div>
					<label>Organisme<span>*</span></label>
					<input type="text" class="phone" name="organisme" placeholder="">
					<div class="clearfix"></div>
					<label>Description de l'organisme <span>*</span></label>
					<textarea class="mess" placeholder="ecrire quelques lignes" name="description_orga"></textarea>
					<div class="clearfix"></div>
					<label> Description du poste <span>*</span></label>
					<textarea class="mess" placeholder="ecrire quelques lignes" name="description_poste"></textarea>
					<div class="clearfix"></div>
					<label>Profile <span>*</span></label>
					<input type="text" class="name" placeholder="" name="profile">
					<div class="clearfix"></div>
					<label>secteur<span>*</span></label>
					<select class="" name="secteur">
					  <option value="">secteur</option>
					
					  <option value="banque">banque</option>
					  <option value="it">IT</option>
					  <option value="econiomie">economie</option>
					...
					<label>Salaire <span>*</span></label>
					<input type="text" class="name" placeholder="" name="salaire">
					<div class="clearfix"></div>
					<label>Telephone <span>*</span></label>
					<input type="text" class="name" placeholder="" name="telephone">
					<div class="clearfix"></div>
					<label>Email <span>*</span></label>
					<input type="text" class="name" placeholder="" name="email">
										<div class="clearfix"></div>

<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="metier.gestionEmploi"  %>
  <%@page import="metier.User"  %>
 
 <%@ page import="java.util.List" %> 
 
  <%@page import="metier.Emploi"  %>
...
<body>
		...
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				<ul>
					...
					<li class="dropdown head-dpdn">
						<a href="help.html">Deconnexion</a>
					</li>
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			...
			<a href="indexo.jsp"><i class="fa fa-home home_1"></i></a> / 
			<span>Emploi</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	<!-- Mobiles -->
			...
			<div class="select-box">
				...
				<div class="browse-category ads-list">
					...
					<select class="selectpicker show-tick" data-live-search="true">
					  <option data-tokens="Electronics & Appliances">Electroniques et multimedia</option>
					  <option data-tokens="Jobs">Emplois</option>
					  <option data-tokens="Real Estate">immobilier</option>
					</select>
				</div>
				
			   <div class="search-product ads-list">

				<a class="post-w3layouts-ad" href="post-emploi.jsp">Ajouter une annonce</a>
				</div>
					  ...
					  <div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						   <div>
								...
								<div class="clearfix"></div>
							<ul class="list">
							<% List<Emploi> liste = gst.listeEmploi() ;
							 for(Emploi el : liste)
							 {
							 ...
							 %>
								<a href="single.html">
									...
									<h5 class="title"><%= el.getTitre() %></h5>
									<span class="adprice"><%=el.getOrganisme() %> </span>
									<p class="catpath"><%=el.getPoste()%></p>
									<p class="catpath"><%=el.getProfile()%></p>
									
									</section>
									<section class="list-right">
									<span class="date"><%=el.getSecteur() %></span>
									<span class="cityname"><%=el.getVille() %></span>
									</section>
									<div class="clearfix"></div>
									</li> 
								</a>

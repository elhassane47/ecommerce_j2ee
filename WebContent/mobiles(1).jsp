...
<body>
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			...
			<span>Electroniques et multimedia</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	<!-- Mobiles -->
		...
		<div class="container">
			<div class="select-box">
			   ...
			   <div class="search-product ads-list">
				...
				<a class="post-w3layouts-ad" href="post-ad.jsp">Ajouter une annonce</a>
				</div>
							...
							<% List<Electro> liste = gst.listeElectro() ;
							 ...
							 %>
								<a href="single.html">
									...
									<h5 class="title"><%= el.getReference() %></h5>
									<span class="adprice"><%=el.getPrix() %> DHS</span>
									<p class="catpath"><%=el.getDescription() %></p>
									</section>

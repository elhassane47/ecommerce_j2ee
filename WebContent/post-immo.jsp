	...
	<div class="submit-ad main-grid-border">
		<div class="container">
			...
			<div class="post-ad-form">
				<form method="post" action="postimmo">
					...
					<textarea class="mess" placeholder="Ecrire quelques mots pour attirer les achetteurs " name="description"></textarea>
					<div class="clearfix"></div>
					...
					<div class="clearfix"></div>
					<label>Surface en m²<span>*</span></label>
					<input type="text" class="name" placeholder="" name="surface">
					<div class="clearfix"></div>
					<label>Adresse<span>*</span></label>
					<input type="text" class="name" placeholder="" name="adresse">
					<div class="clearfix"></div>

		...
		<div class="container">
			<div class="select-box">
			   ...
			   <div class="search-product ads-list">
				...
				<a class="post-w3layouts-ad" href="post-immo.jsp">Ajouter une immobilier</a>
				</div>
							...
							<% List<Immo> liste = gst.listeImmo() ;
							 ...
							 %>
								<a href="single.html">
									...
									<p class="catpath"><%=el.getDescriptiion() %></p>
									</section>
									<section class="list-right">
									<span class="date"><%=el.getSurface() %>m�</span>
